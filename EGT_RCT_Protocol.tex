...
Preclinical evidence links EGT to the SIRT6 pathway, a key regulator of DNA repair, telomere maintenance, and metabolic homeostasis. EGT depletion accelerates aging phenotypes in animal models, while supplementation extends healthspan. In humans, low circulating EGT is associated with increased risk of cognitive decline, cardiovascular disease, and frailty \cite{yau2024,gallagher2023}. A pilot study of EGT in mild cognitive impairment showed promising signals for cognitive preservation \cite{yau2024}.
